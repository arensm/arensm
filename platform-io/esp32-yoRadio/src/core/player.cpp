...
QueueHandle_t playerQueue;
  ...
  void ResetChip(){
    ...
    Player::Player() {}
  #else
    #ifndef I2S_DAC_CHANNEL
      #define I2S_DAC_CHANNEL I2S_DAC_CHANNEL_BOTH_EN
    #endif
    Player::Player(): Audio(true, I2S_DAC_CHANNEL)  {}
  #endif
#endif
...
void Player::_play(uint16_t stationId) {
  ...
  // Ein geoeffnetes Webinterface kann den internen Heap so fragmentieren,
  // dass der Decoder trotz genuegend freier Bytes keinen grossen Block mehr
  // erhaelt. Die Browser-Verbindung baut sich nach der Initialisierung neu auf.
