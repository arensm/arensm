/*************************************************************************************
    CYD/ILI9341 320x240 layout with a compact stereo peak meter on the left.
*************************************************************************************/
...
const WidgetConfig vuConf         PROGMEM = { TFT_FRAMEWDT, 96, 1, WA_LEFT };
...
/* BANDS  */                             /* { onebandwidth, totalheight, bandHspace, bandVspace, numofbands, fadespeed } */
// 9 Pixel je Kanal werden als zwei 4-Pixel-Saeulen mit 1 Pixel Abstand gezeichnet.
// Die CYD-Sonderimplementierung zeichnet ohne Canvas/Heap-Puffer.
const VUBandsConfig bandsConf     PROGMEM = { 9, 80, 3, 2, 10, 2 };
...
const MoveConfig   weatherMoveVU  PROGMEM = { 38, 97, MAX_WIDTH-38+TFT_FRAMEWDT };
